...
export function resolveFolderIcon(name = '') {
  ...
  const map = {
    src: { Icon: MdCode, color: '#66c8ff' },
    app: { Icon: MdViewModule, color: '#7bd3ff' },
    components: { Icon: MdOutlineExtension, color: '#6de0d2' },
    core: { Icon: MdOutlineSettings, color: '#8da7ff' },
    ...
    '.github': { Icon: MdOutlineHub, color: '#a1b1d1' },
    '.vscode': { Icon: MdOutlineSettings, color: '#72b9ff' },
    lib: { Icon: MdLibraryBooks, color: '#f0c65e' },
    utils: { Icon: MdOutlineBuild, color: '#e8a964' },
    hooks: { Icon: MdCode, color: '#7adbbd' },
  };
...
export function resolveFileIcon(name = '') {
  ...
  const exact = {
    ...
    '.env': { Icon: MdOutlineSettings, color: '#f2f252' },
    'dockerfile': { Icon: SiDocker, color: '#2496ed' },
    'makefile': { Icon: MdOutlineBuild, color: '#e8a964' },
  };
  ...
  const ext = {
    ...
    csv: { Icon: MdDataset, color: '#9cf2a9' },
    ps1: { Icon: MdTerminal, color: '#2771d9' },
  };

export const KEYBINDING_COMMANDS = [
  ...
  },
  {
    ...
    label: 'Search: Replace In Files',
    category: 'Search',
    defaultBinding: 'ctrl+shift+h',
    keywords: ['search replace in files'],
  },
  {
  ...
  },
  {
    ...
    category: 'View',
    defaultBinding: 'ctrl+k z',
    keywords: ['zen mode distraction free focus'],
  },
  {
    id: 'workbench.action.escapeCurrentMode',
    label: 'View: Escape Current Mode',
    category: 'View',
    defaultBinding: 'escape escape',
    keywords: ['escape zen mode close immersive mode'],
  },
  {
    id: 'workbench.action.toggleCenteredLayout',
    label: 'View: Toggle Centered Layout',
    category: 'View',
    defaultBinding: '',
    keywords: ['centered layout editor width'],
  },
  {
    id: 'workbench.action.toggleStatusbarVisibility',
    label: 'View: Toggle Status Bar Visibility',
    category: 'View',
    defaultBinding: '',
    keywords: ['status bar footer'],
  },
  {
  ...
  },
  {
    ...
    label: 'View: Toggle Output',
    category: 'View',
    defaultBinding: '',
    keywords: ['output logs panel'],
  },
  {
    id: 'workbench.debug.action.toggleRepl',
    label: 'Debug: Toggle Debug Console',
    category: 'Run & Debug',
  ...
  },
  {
    ...
    keywords: ['terminal new create'],
  },
  {
    id: 'workbench.action.terminal.split',
    label: 'Terminal: Split Terminal',
    category: 'Terminal',
    defaultBinding: 'ctrl+shift+5',
  ...
  },
  {
    ...
    keywords: ['back previous location editor'],
  },
  {
    ...
    keywords: ['forward next location editor'],
  },
  {
  ...
  },
  {
    ...
    label: 'Go: Peek Definition',
    category: 'Go',
    defaultBinding: 'alt+f12',
    keywords: ['peek definition'],
  },
  {
    id: 'editor.action.peekReferences',
    label: 'Go: Peek References',
    category: 'Go',
    defaultBinding: 'alt+shift+f12',
    keywords: ['peek references'],
  },
  {
  ...
  },
  {
    ...
    label: 'Explorer: Reveal Active File',
    category: 'Explorer',
    defaultBinding: 'ctrl+k r',
  ...
  },
  {
    ...
    label: 'Explorer: Copy Path',
    category: 'Explorer',
    defaultBinding: 'shift+alt+c',
    keywords: ['copy file path'],
  },
  {
    id: 'explorer.copyRelativePath',
    label: 'Explorer: Copy Relative Path',
    category: 'Explorer',
    defaultBinding: 'shift+alt+r',
    keywords: ['copy relative path'],
  },
  {
    id: 'edit.undo',
    label: 'Edit: Undo',
  ...
  },
  {
    ...
    category: 'View',
    defaultBinding: '',
    keywords: ['breadcrumbs path navigation'],
  },
  {
    id: 'workbench.action.newWindow',
    label: 'Welcome: New Window',
    category: 'Welcome',
    defaultBinding: '',
    keywords: ['new window spawn duplicate'],
  },
  {
    ...
    category: 'Help',
    defaultBinding: '',
    keywords: ['check updates version release'],
  },
];
